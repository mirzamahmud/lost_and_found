...
import 'components/others_preview/cosmetics_info_preview.dart';
import 'components/others_preview/electronics_info_preview.dart';
import 'components/others_preview/garments_info_preview.dart';
...
import 'components/others_preview/umbrella_info_preview.dart';
import 'components/others_preview/watch_info_preview.dart';

class UmbrellaPreviewScreen extends StatelessWidget {
  UmbrellaPreviewScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppbar('umbrella'.tr),
