...
import 'package:online_gd/screen/ui/other_expansion/mobile_identity_expansion.dart';
import 'package:online_gd/screen/ui/other_expansion/mobile_info_expansion.dart';
...
class MobileEntryScreen extends StatelessWidget {
  MobileEntryScreen({Key? key}) : super(key: key);
              ...
              children: [
                ...
                controller.showIdentity.value
                  ...
                  child: ExpansionTile(
                    ...
                    children: const [MobileIdentityExpansion()],
                  ),
                )
                    : const SizedBox(),
                const SizedBox(height: 8),
