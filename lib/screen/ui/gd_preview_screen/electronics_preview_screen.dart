...
class ElectronicsPreviewScreen extends StatelessWidget {
  ElectronicsPreviewScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppbar('electronics'.tr),
      body: SingleChildScrollView(
        child: Column(
          children: [
             ElectronicsInfoPreview(),
            const SizedBox(height: 20),
             IdentityInfoPreview(
              identityInfoValue: controller.apiPostData['identificationMark'] ?? '',
            ),
            const SizedBox(height: 20),
            PlaceTimePreview(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: TextButton(
                        onPressed: () {
                          othersController.postOthersEntryData(controller.apiPostData);
                        },
